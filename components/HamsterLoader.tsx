...
// Running-hamster-in-a-wheel loader. Converted from the styled-components
// source to Next's built-in styled-jsx (no extra dependency). Pure CSS — the
// wheel and every limb are animated with keyframes.
